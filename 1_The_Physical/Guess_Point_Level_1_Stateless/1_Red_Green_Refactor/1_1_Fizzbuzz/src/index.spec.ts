...
describe("fizzbuzz", () => {
    ...
    // 1 and 2
    it("should return 12 when 1,2 is passed", () => {
        expect(fizzbuzz(1, 2)).toBe("12");
    });

    // 1, 2, Fizz
    it("should return 12Fizz when 1,3 is passed", () => {
        expect(fizzbuzz(1, 3)).toBe("12Fizz");
    });

    // 1, 2, Fizz, 4, Buzz
    it("should return 12Fizz4Buzz when 1,5 is passed", () => {
        expect(fizzbuzz(1, 5)).toBe("12Fizz4Buzz");
    });

    // 1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz
    it("should return 12Fizz4BuzzFizz78FizzBuzz when 1,10 is passed", () => {
        expect(fizzbuzz(1, 10)).toBe("12Fizz4BuzzFizz78FizzBuzz");
    });

    // 1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14, FizzBuzz
    it("should return 12Fizz4BuzzFizz78FizzBuzz11Fizz1314FizzBuzz when 1,15 is passed", () => {
